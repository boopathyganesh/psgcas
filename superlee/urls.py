...
urlpatterns = [
    ...
    path('admin/students-data', views.student_data, name='student_data'),
    path('admin/msg-center', views.msg_center, name='msg_center'),
    path('admin/attendance', views.admin_attendance, name='admin_attendance'),
    path('admin/account-settings', views.acc_settings, name='acc_settings'),
    path('CDC-Functions', views.cdc_function, name='cdc_function'),
